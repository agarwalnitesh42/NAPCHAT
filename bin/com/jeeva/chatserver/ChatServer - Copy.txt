...
import com.jeeva.chatclient.ImagePanel;
...
public class ChatServer extends Frame implements Serializable, ActionListener,Runnable,CommonSettings {
	...
	public ChatServer() {
		...
		this.setTitle("NAP CHAT");
		this.setLocation(460,200);
		URL ICONourl = this.getClass().getResource("/com/jeeva/chatserver/images/icon.gif");
		//Image iconImage = Toolkit.getDefaultToolkit().getImage("com/jeeva/chatserver/images/icon.gif");
		try {
			ICONimg = ImageIO.read(ICONourl);
		...
		Label lblTitle = new Label("NAP CHAT SERVER V1.0",1);
...
//	      getContentPane().add(j2);
		...
		Panel BannerPanel = new ImagePanelServer(this,ImgBanner);
		centerPanel.add("south",BannerPanel);
