...
public class ChatClient extends Frame implements Serializable,Runnable,KeyListener,ActionListener,CommonSettings {
	...
	{		
		...
		running_procedureitem = new MenuItem("How to run software");
		running_procedureitem.addActionListener(this);
		aboutmenu.add(aboutitem);
		aboutmenu.add(running_procedureitem);
		...
		UserRoom	="";
		IconCount 	= 21;
		ChatLogo	= "/com/jeeva/chatclient/images/logo.gif";
		BannerName 	= "/com/jeeva/chatclient/images/defaultbanner.gif";
		RoomList 	= "";
		IsProxy = false;
		...
		ColorMap[1] =  new Color(128,122,115);
		/*******Button Foreground*********/
		ColorMap[2] =  Color.black; 
		/*******Button Background**************/
		//ColorMap[3] =  new Color(224,236,254); 
		ColorMap[3] =  new Color(189,189,189); 
		/*******sstab button****************/
		ColorMap[4] =  new Color(128,122,115);
		/*******message canvas*********/
		...
		ColorMap[5] =  new Color(255,115,0);
		/**********Loading Images*********/		
		tracker = new MediaTracker(this);
		int ImageCount = 0;
		URL Imglogourl = this.getClass().getResource("/com/jeeva/chatclient/images/logo.gif");
		URL bannerurl = this.getClass().getResource("/com/jeeva/chatclient/images/defaultbanne2r.gif");
		//URL Iconsurl = this.getClass().getResource("/com/jeeva/chatclient/images/defaultbanner.gif");
		try {
		...
		{   try {
			URL url = this.getClass().getResource("/com/jeeva/chatclient/icons/photo_"+G_ILoop+".gif");
			IconArray[G_ILoop] = ImageIO.read(url);
		} catch (IOException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
		     //mulimage = ImageIO.read(url);
		...
		try{
		  ...
		  try {
		URL logourl = this.getClass().getResource("/com/jeeva/chatclient/images/logo.gif");
	...
	private void InitializeAppletComponents()
	{
	    ...
	    CmdSend2 = new CustomButton(this,"Send File!");
...
//	    CmdSend2.addActionListener(this);
//	    TextBoxPanel.add("West",LblGeneral);
//	    TextBoxPanel.add("Center",TxtMessage);
//	    TextBoxPanel.add("East",CmdSend2);
//	    InputPanel.add("Center",TextBoxPanel);
	...
	public void actionPerformed(ActionEvent evt)
	{
		...
		if(evt.getSource().equals(running_procedureitem))
		{			
			MessageBox messagebox = new MessageBox(this,false);					
			messagebox.AddMessage("~~13 "+HOW_TO_RUN);
			messagebox.AddMessage("Developed By...");
			messagebox.AddMessage(COMPANY_NAME);
	...
	Button CmdSend,CmdExit,CmdSend2;
	Font TextFont;
	...
	MenuItem quititem,aboutitem,running_procedureitem;
}
