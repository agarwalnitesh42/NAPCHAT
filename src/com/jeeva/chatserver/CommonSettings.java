...
public interface CommonSettings
{
	...
	public String PRODUCT_NAME					= "	NAP CHAT v1.0";
	public int TOP_PANEL_START_POS			=	30;
	//public String HOW_TO_RUN					= "	First start the server then startthe client side window";
}